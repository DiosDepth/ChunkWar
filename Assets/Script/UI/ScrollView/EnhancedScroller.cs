...
public class EnhancedScroller : MonoBehaviour, IBeginDragHandler, IEndDragHandler
{
    ...
    void Awake()
    {
        ...
        if (scrollDirection == ScrollDirectionEnum.Vertical)
        {
            ...
            _container.pivot = ContentMid ? new Vector2(0.5f, 0.5f) : new Vector2(0.5f, 1f);
        }
        else
        {
            _container.anchorMin = Vector2.zero;
            _container.anchorMax = new Vector2(0, 1f);
            _container.pivot = ContentMid ? new Vector2(0.5f, 0.5f) : new Vector2(0, 0.5f);
        }
