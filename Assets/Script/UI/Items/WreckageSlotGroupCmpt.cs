...
public class WreckageSlotGroupCmpt : EnhancedScrollerCellView
{
    public WreckageSlotItemCmpt[] items;

    protected override void Awake()
    {
        base.Awake();
        items = transform.GetComponentsInChildren<WreckageSlotItemCmpt>();
    }
